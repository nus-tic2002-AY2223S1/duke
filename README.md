...
3. After that, locate the `src/main/java/nus.duke.Duke.java` file, right-click it, and
   choose `Run nus.duke.Duke.main()` (if the code editor is showing compile errors, try restarting the IDE). If the
