...
public class Duke {
    ...
    public void run() throws IOException {
        ...
        while(!fullCommand.equals("bye") ){
            ...
            if(fullCommand.equals("list")){ //listCommand
                tasks.listTasks();
            }
            else if (fullCommand.equals("bye")) {//ExitCommand
                System.out.println("Bye. Hope to see you again soon!");
            }
            else if (fullCommand.startsWith("mark")) {//MarkCommand
                taskID = filterTaskID(fullCommand);
                tasks.myTaskList[taskID].markAsDone();
            }
            else if (fullCommand.startsWith("unmark")) {//Unmark Command
                taskID = filterTaskID(fullCommand);
                tasks.myTaskList[taskID].markAsNotDone();
            }
            else if (fullCommand.startsWith("todo") || fullCommand.startsWith("deadline") || fullCommand.startsWith("event") ) { //AddCommand
                try{
            ...
            else if(fullCommand.startsWith("delete")){ //DeleteCommand
                try{
                    taskID = filterTaskID(fullCommand);
            ...
            else if(fullCommand.startsWith("find")){ //FindCommand
