...
public class Messages {
    ...
    public static final String MESSAGE_NO_KEYWORD_FOR_EVENT_DEADLINE =
            "Please use keyword \"/\" to represent date and time. E.g. /at 6/10/2022 1600\n";
    public static final String MESSAGE_WRONG_TIME_FORMAT =
            "Please key in correct time format. E.g. 1600.\n";
    ...
    public static final String MESSAGE_NO_TIME_FOR_DEADLINE_EVENT = "Invalid command!"
            + " Date and time for deadline or event cannot be empty.\n";
    public static final String MESSAGE_NOT_TIMESLOT_FOR_EVENT = "Please enter a timeslot for the event! "
            + "Or use deadline instead. \n";
    public static final String MESSAGE_NO_END_DATETIME = "Please enter an end date "
            + "or time for the event, or use deadline instead. \n";
    ...
    public static final String MESSAGE_DOAFTER_FORMAT = "Wrong DoAfter command format, please use the below format:\n"
            ...
            + Ui.getLinePrefix() + "2. _____(task description)_____ after DD/MM/YYYY or DD/MM/YYYY hhmm\n";
}
