...
public class DeadlineTest {
    ...
    public void DeadlineToStringTest() {
        Deadline deadline = new Deadline("Finish math homework", "03 June 2023 1130");
        assertEquals("[D][ ] Finish math homework (by: 03 June 2023 1130)", deadline.toString());
    }

    @Test
    public void DeadlineStringToOutput() {
        Deadline deadline = new Deadline("Finish math homework", "03 June 2023 1130");
        assertEquals("D | 0 | Finish math homework | 03 June 2023 1130", deadline.stringToOutput());
    }
